...
public class RegularExpressions {
	public static void main(String[] args) {
		...
		Pattern passwordP = Pattern.compile("^[A-Za-z0-9@|$|%|&]{8,}");//for Password at least one in uppercase and one numeric number
		Matcher passwordM = passwordP.matcher("Abc2et$t");//Has exactly one special character
		...
		System.out.println("string matches the given Regex for Password -" +  passwordM.matches());
